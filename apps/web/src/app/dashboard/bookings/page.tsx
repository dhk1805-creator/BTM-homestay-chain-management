    ...
    <div className="p-6 min-h-full" style={{color:'#E2E8F0'}}>
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          {[{v:'',l:'Tất cả'},{v:'CONFIRMED',l:'Đã xác nhận'},{v:'CHECKED_IN',l:'Đã check-in'},{v:'CHECKED_OUT',l:'Đã check-out'}].map(f=>(
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {bookings.map((b,i) => {
            ...
            return (
              <div key={b.id} className="rounded-2xl p-5 flex items-center gap-4 transition cursor-pointer hover:bg-white/[0.02]"
                ...
                <div className="text-right px-4">
                  <p className="text-base font-bold text-white">{Number(b.totalAmount).toLocaleString('vi-VN')} ₫</p>
                </div>
